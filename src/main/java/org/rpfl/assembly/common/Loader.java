...
public class Loader {
    ...
    private ResourceFingerprint load(URL url){
        ...
        try {
            InputStreamHash inputStreamHash = remoteUrlContentHasher.hash(url);

            resourceFingerprint.setHash(inputStreamHash.getSHA3_384());

            resourceFingerprint.setSize(inputStreamHash.getContentSize());
